  ...
  return (
    <div className="flex h-[100dvh] overflow-hidden bg-background text-foreground">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <Header />
        <main className="flex-1 w-full px-4 sm:px-6 lg:px-8 pt-3 lg:pt-5 lg:pb-4 box-border min-w-0 overflow-y-auto relative flex flex-col after:content-[''] after:block after:h-32 after:shrink-0 lg:after:h-0">
          {isPageLoading ? (
